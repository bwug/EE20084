...
A = np.array([[1, 3], [-2, 1]]) # Creates a 2x2 matrix

B = np.array([[-2, 1], [2, 3]]) # Creates a 2x2 matrix
...
P = np.array([[1, 3, -2, 4],[-2, 1, 4, -1]]) # Creates a matrix with 2 rows and 4 columns

Q = np.array([[-2, 1],[2, 3],[-4, 1],[1, -3]])
